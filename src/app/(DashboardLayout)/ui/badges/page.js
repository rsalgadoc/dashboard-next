      ...
      <Row>
        ...
        <Col xs="12" md="6">
          ...
          <Card>
            ...
            <CardBody className="">
              <div>
                <Badge href={null} color="primary">
                  Primary
                </Badge>
                <Badge href={null} color="secondary" className="ms-3">
                  Secondary
                </Badge>
                <Badge href={null} color="success" className="ms-3">
                  Success
                </Badge>
                <Badge href={null} color="danger" className="ms-3">
                  Danger
                </Badge>
                <Badge href={null} color="warning" className="ms-3">
                  Warning
                </Badge>
                <Badge href={null} color="info" className="ms-3">
                  Info
                </Badge>
                <Badge href={null} color="light" className="ms-3">
                  Light
                </Badge>
                <Badge href={null} color="dark" className="ms-3">
                  Dark
                </Badge>
              </div>
            </CardBody>
